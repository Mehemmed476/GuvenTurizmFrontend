            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        {/* Kart 1 */}
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-primary/30 transition-colors group text-center">
                            <div className="w-16 h-16 mx-auto bg-orange-50 rounded-full flex items-center justify-center text-primary mb-6 group-hover:scale-110 transition-transform">
                                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 mb-3">Tam Təmizlik</h3>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-primary/30 transition-colors group text-center">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3">100% Güvənli</h3>
                            <p className="text-gray-500">
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-primary/30 transition-colors group text-center">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3">Dəstək Xidməti</h3>
                            <p className="text-gray-500">
